...
<ol>
  ...
  <li>Create Trailer Component with react-player
    <ul>
      <li>Create trailer folder in components folder. Create Trailer.js in trailer folder.</li>
  ...
  <li>Create Movie Reviews Functionality
    <ul>
      <li>Create reviewForm folder in components folder. Create ReviewForm.js in reviewForm folder.</li>
